...
const UZ: TranslationSchema = {
  ...
  home: {
    ...
    ai_banner_title: "AI Bek sizga yordam beradi",
  ...
  chat: {
    ...
    plan_tour_intro: "Salom Bek! Men sayohat rejasi tuzmoqchiman. Saqlagan joylarim:",
  ...
  profile: {
    ...
    benefit2_title: "AI Bek bilan suhbat",
  ...
  auth: {
    ...
    success_feature1: "AI Bek bilan suhbat boshlash",
...
const RU: TranslationSchema = {
  ...
  home: {
    ...
    all_title: "Все места",
    ai_banner_title: "ИИ Бек готов помочь",
    ai_banner_desc:
  ...
  chat: {
    ...
    plan_tour_intro: "Привет, Бек! Я хочу спланировать маршрут. Мои сохранённые места:",
  ...
  auth: {
    ...
    success_feature1: "Начать общение с ИИ Бек",
...
const EN: TranslationSchema = {
  ...
  home: {
    ...
    ai_banner_title: "AI Bek is here to help",
  ...
  chat: {
    ...
    plan_tour_intro: "Hi Bek! I want to create a travel plan. My saved places:",
  ...
  profile: {
    ...
    benefit2_title: "Chat with AI Bek",
  ...
  auth: {
    ...
    success_feature1: "Start chatting with AI Bek",
...
const ZH: TranslationSchema = {
  ...
  chat: {
    ...
    plan_tour_intro: "你好，贝克！我想制定旅行计划。我保存的地点：",
...
const DE: TranslationSchema = {
  ...
  home: {
    ...
    all_title: "Alle Orte",
    ai_banner_title: "KI Bek hilft Ihnen weiter",
    ai_banner_desc:
  ...
  chat: {
    ...
    plan_tour_intro: "Hallo Bek! Ich möchte einen Reiseplan erstellen. Meine gespeicherten Orte:",
  ...
  profile: {
    ...
    benefit2_title: "Chat mit KI Bek",
  ...
  auth: {
    ...
    success_feature1: "Chat mit KI Bek starten",
...
const FR: TranslationSchema = {
  ...
  home: {
    ...
    ai_banner_title: "L'IA Bek est là pour vous aider",
    ai_banner_desc:
  ...
  chat: {
    ...
    plan_tour_intro: "Bonjour Bek ! Je veux créer un plan de voyage. Mes lieux sauvegardés :",
  ...
  profile: {
    ...
    benefit2_title: "Discuter avec IA Bek",
  ...
  auth: {
    ...
    success_feature1: "Démarrer une conversation avec IA Bek",
