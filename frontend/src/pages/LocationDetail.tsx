    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 px-4">
        ...
        <p className="text-[var(--muted-foreground)] text-sm text-center">
          Bu joy mavjud emas yoki o&apos;chirilgan
        </p>
        <button
    ...
    <div className="pb-8">
      ...
      <div className="relative h-72 md:h-96 overflow-hidden">
        ...
        <button
          ...
          className={cn(
            ...
            inPlan ? "bg-teal-500" : "bg-black/50 hover:bg-teal-500/70"
          )}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5">
          <span className="inline-block text-xs font-semibold px-2.5 py-1 rounded-full bg-teal-500/80 text-white backdrop-blur-sm mb-2">
      ...
      <div className="px-4 mt-4 grid grid-cols-3 gap-2 mb-5">
        <div className="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-[var(--card)] border border-[var(--border)]">
          ...
          <span className="text-[10px] text-[var(--muted-foreground)]">Narx</span>
        </div>
        <div className="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-[var(--card)] border border-[var(--border)]">
          ...
          <span className="text-[10px] text-[var(--muted-foreground)]">Muddat</span>
        </div>
        <div className="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-[var(--card)] border border-[var(--border)]">
          ...
          <span className="text-[10px] text-[var(--muted-foreground)]">Fasl</span>
        </div>
      </div>
      ...
      <div className="px-4 flex gap-3">
        <button
          ...
          className={cn(
            ...
            inPlan
              ? "bg-teal-500/15 border border-teal-500/40 text-teal-400 hover:bg-teal-500/25"
              : "bg-teal-500 hover:bg-teal-600 text-white shadow-md shadow-teal-500/20"
          )}
        >
          {inPlan ? (
            <>
              <BookmarkCheck className="w-4 h-4" /> Rejada bor
            </>
          ) : (
            <>
              <Bookmark className="w-4 h-4" /> Rejaga qo&apos;shish
            </>
          )}
        </button>
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[var(--muted)] border border-[var(--border)] hover:border-teal-500/40 text-[var(--foreground)] text-sm font-semibold transition-all active:scale-[0.97]"
        >
